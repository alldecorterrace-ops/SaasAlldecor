...
| 4. Auditoría completa | 274 pruebas locales y CI; primera sesión real de staging con dos empresas ficticias, creación/edición de clientes, configuración, invitación y revocación. Defecto de reintento de conflictos corregido y probado con dos pestañas y repetición. | Resto de recorridos autenticados por cinco perfiles, escritorio/móvil real, aceptación de invitaciones, aislamiento frente a usuarios ajenos y concurrencia de todas las operaciones. La salud HTTP no sustituye esos recorridos. |
| 5. Recuperación y operación | Staging publicado con 28 migraciones; registro público cerrado, Email con receptor privado, primera cuenta autenticada e invitación sintética capturada. Corrección de arranque verificada. Carpeta privada de Drive y herramientas de copia/recuperación preparadas; ensayos sintéticos y job PostgreSQL aprobados. | Otras cuentas y recorridos de staging, acceso real/ETag/cuotas/custodia de clave/OAuth, captura completa, calendario y retención, alertas, restauración y carga. No hay todavía respaldo cifrado del destino verificado en Drive ni RPO/RTO acreditados. |
