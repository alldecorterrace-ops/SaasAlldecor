...
| 3. Migración | Respaldo privado y restauración aislada. Consulta histórica de estimados, clientes, proyectos, facturas, pagos, documentos y contratos publicada; originales y relaciones verificados en Supabase. PDF disponibles conservados en almacenamiento privado con descarga protegida. Copias editables de clientes válidos incorporadas con enlaces al histórico; coincidencias y datos inválidos separados para revisión. Se conservaron los registros actuales. | Revisar pantallas y descargas con sesión real; resolver clientes pendientes, referencias y archivos faltantes; completar las demás entidades operativas; conciliar el delta desde el respaldo. |
