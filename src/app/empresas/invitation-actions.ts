...
export async function createInvitation(
  ...
  const { error } = await db.rpc("create_company_invitation", {
    p_company: companyId,
    p_id: parsed.data.id,
  ...
  return {
    success:
      "Invitación pendiente. La persona puede aceptarla en Tus empresas al entrar con ese correo confirmado. No se ha enviado un correo automático.",
  };
}
